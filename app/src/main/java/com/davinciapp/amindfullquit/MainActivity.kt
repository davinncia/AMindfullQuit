...
import com.davinciapp.amindfullquit.developer.DeveloperActivity
import com.davinciapp.amindfullquit.meditation.MeditationActivity
import com.davinciapp.amindfullquit.principles.PrinciplesActivity
import com.davinciapp.amindfullquit.smoking.SmokingActivity
...
class MainActivity : AppCompatActivity(), View.OnTouchListener {
    ...
    private fun openActivity(tag: String) {
        ...
        intent = when (tag) {
            ...
            "CODER" -> DeveloperActivity.newIntent(this)
